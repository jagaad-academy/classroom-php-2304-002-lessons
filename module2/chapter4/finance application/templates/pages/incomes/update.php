    ...
    <div class="col-12">
        <form action="/incomes/update/id/<?=$income['income_id']?>" method="post">
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if($income['periodicity'] == 0) echo "checked"; ?> type="radio" name="periodicity" id="periodicity1" value="0" >
                        <label class="form-check-label" for="periodicity1">
                            No
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" <?php if($income['periodicity'] == 1) echo "checked"; ?> type="radio" name="periodicity" id="periodicity2" value="1">
                        <label class="form-check-label" for="periodicity2">
                            Fixed
                        </label>
                    </div>
                    <div class="form-check disabled">
                        <input class="form-check-input" <?php if($income['periodicity'] == 2) echo "checked"; ?> type="radio" name="periodicity" id="periodicity3" value="2">
            ...
            <fieldset class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" <?php if($income['status'] == 0) echo "checked"; ?> type="radio" name="status" id="status1" value="0" >
                        <label class="form-check-label" for="status1">
                            Unreceived
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" <?php if($income['status'] == 1) echo "checked"; ?> type="radio" name="status" id="status2" value="1">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="user-email" name="user-email" value="<?=$income['email']?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
